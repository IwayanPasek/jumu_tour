...
<div class="container-fluid px-0" style="max-width: 900px;">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            ...
            <h1 class="h3 fw-bold text-dark mb-1">Edit Kategori: {{ $category->name }}</h1>
            <p class="text-muted mb-0 small">Perbarui data tema, deskripsi, atau status publikasi kategori.</p>
        </div>
    </div>
